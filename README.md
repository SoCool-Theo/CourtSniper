...
Configure Windows Task Scheduler to launch `sniper.py` automatically at **few minutes before the booking target time**. This gives the browser a minute warm-up buffer before registration.
